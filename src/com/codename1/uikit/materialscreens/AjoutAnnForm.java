...
public class AjoutAnnForm extends Form{
  ...
  String Filenom;
    ...
    public AjoutAnnForm(Resources theme) {
...
date.setType(Display.PICKER_TYPE_DATE);        
        ...
        TextField tfDep = new TextField("", "titre", 20, 0);
        TextField tfArr = new TextField("", "speciality", 20, 0);
        ...
        int ddd=datelyoum-a;
                   ...
                   if (tfDep.getText().length()==0|| tfDescription.getText().length()==0||tfArr.getText().length()==0||cc<0||ddd<0)
                {
                ...
                
                    {
                       ...
                       se.AddAnn(tfDep.getText(), tfDescription.getText(), tfArr.getText() , Integer.parseInt(prix.getText()),db,df,"/photos/"+Filenom);
                 Dialog D = new Dialog();
