...
public class Demande1 {
    ...
    public Demande1(int id, int ida,  int iduserA, int iduserD, String Titre, int etatd ,String Motivation) {
        this.id = id;
        this.iduserA = iduserA;
        this.iduserD = iduserD;
        this.Titre = Titre;
    ...
    public Demande1( int ida,  int iduserA, int iduserD, String Titre, int etatd ,String Motivation) {
