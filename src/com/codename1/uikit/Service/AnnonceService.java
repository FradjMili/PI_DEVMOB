...
public class AnnonceService {
    public void ajoutAnnonce(Annonce ta) {
        ...
        String Url = "http://localhost/PI_DEEV/web/app_dev.php/jobposts/AddAnn/?titre=" + ta.getTitre()+ "&description=" + ta.getDescription()+ "&speciality=" + ta.getSpeciality()+ "&salaire=" + ta.getSalaire()+ "&etatannonce=0";// création de l'URL
    ...
    public void supprimer(Annonce ta) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = "http://localhost/PI_DEEV/web/app_dev.php/jobposts/SupprimerAnnonce/mobile/" + ta.getId();// création de l'URL
